...
public class MathLvl1 : MonoBehaviour
{
    ...
    //    if (!Input.was)
        //{
            buttonSubmit.gameObject.SetActive(false);
            Debug.Log("obj1 was del: " + buttonSubmit.name);
            answerInput.gameObject.SetActive(false);

            Debug.Log("obj1 was del: " + answerInput.name);
            attempsText.gameObject.SetActive(false);

            Debug.Log("obj1 was del: " + attempsText.name);
            answerInput.DeactivateInputField();
    ...
    public void CheckAnswer(string equation)
    {
        ...
        {
            int score = 5;
            ScorePlayer.scorePlayer.ChangeScore(score);
